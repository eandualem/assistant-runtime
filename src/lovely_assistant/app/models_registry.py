...
MODEL_CATALOG: list[ModelEntry] = [
    ...
    ModelEntry(
        ...
        capabilities=["text", "vision"],
        description="Latest GPT generation — balanced performance",
    ),
    ModelEntry(
        ...
        context_window=128_000,
        capabilities=["text", "vision", "thinking"],
        description="Extended reasoning variant of GPT-5.2",
    ),
    ModelEntry(
        ...
        context_window=128_000,
        capabilities=["text"],
        description="Open-weight GPT variant — fast and efficient",
    ),
    # --- Google text ---
    ModelEntry(
