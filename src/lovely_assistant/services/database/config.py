...
class DatabaseConfig(BaseModel):
    ...
    user: str = Field(default="lovely_assistant", description="Database user")
    password: str = Field(default="lovely_assistant", description="Database password")
    name: str = Field(default="lovely_assistant", description="Database name")
