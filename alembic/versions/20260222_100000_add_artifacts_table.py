...
_ECOSYSTEM_CONTENT = (
    "The Lovely Universe \u2014 agents you work with:\n"
    "- Leo (Strategy Co-Architect): What should we do and why? "
    "Deep thinking about product direction and architecture. "
    "\u2192 Route: strategy, architecture, product decisions, design reviews\n"
    "- Ike (Core Orchestrator): How do we get this done? "
    "Coordinates cross-org work and task breakdown. "
    "\u2192 Route: task coordination, cross-org requests, workflow questions\n"
    "- Hamilton (Arclio Orchestrator): Manages all Arclio coding agents "
    "and intra-Arclio coordination. "
    "\u2192 Route: Arclio-specific tasks, Arclio repo coordination\n"
    "- Curie (Loveble Orchestrator): Manages all Loveble coding agents "
    "and intra-Loveble coordination. "
    "\u2192 Route: Loveble-specific tasks, Loveble repo coordination\n"
    "- Bell (WF Orchestrator): Manages all WF coding agents "
    "and intra-WF coordination. "
    "\u2192 Route: WF-specific tasks, WF repo coordination\n"
    "- Feynman (Orchestration Optimizer): Studies and improves orchestration "
    "patterns, agent configs, heartbeats, skills. "
    "\u2192 Route: orchestration improvements, agent configuration, naming, scheduling\n"
    "- Ada (Spec Agent): Spec bootstrapping, quality review, "
    "consistency oversight across all repos. "
    "\u2192 Route: specification gaps, spec quality, cross-repo contract definitions\n"
    "- Brunel (Infrastructure Agent): Symlinks, SDD shadow layer, "
    "repo connectivity, workspace structure. "
    "\u2192 Route: infrastructure changes, symlinks, workspace connectivity\n"
    "- Gallup (Market Research): Competitive analysis, market sizing, "
    "opportunity validation, niche identification. "
    "\u2192 Route: market research, competitive landscape, pricing analysis, niche validation\n"
    "- Coding Agents (Implementation): Write code, run tests, follow specs. "
    "One per repository. "
    "\u2192 Route: implementation tasks (routed via org orchestrators, not directly)"
)
